...
internal sealed class JsExpandoText : JsText, IDynamicMetaObjectProvider, IExpandoNode
{
    internal JsExpandoText(IText text, DomContext context) : base(text, context)
    {
    }
