...
{
    public DefaultPlaywrightCrawler(IRobotClient robotClient, IOptions<HeadlessCrawlerOptions> options, ILogger<DefaultPlaywrightCrawler> logger) : base(robotClient, options, logger)
    {
    }
